...
var _createCanvasDefault = parcelHelpers.interopDefault(_createCanvas);
var _renderer = require("./renderer");
var _rendererDefault = parcelHelpers.interopDefault(_renderer);
const WIDTH = window.innerWidth;
const HEIGHT = window.innerHeight;
const { ctx , canvas  } = (0, _createCanvasDefault.default)({
    width: WIDTH,
    height: HEIGHT
});
document.body.append(canvas);
(0, _rendererDefault.default)(canvas, ctx, WIDTH, HEIGHT)();

},{"./createCanvas":"lyLua","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./renderer":"g6IVn"}],"lyLua":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"g6IVn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function renderer(canvas, ctx, width, height) {
    var mat = new DOMMatrix().translate(0, 0).scale(1, 1);
    var _a = (0, _createCanvasDefault.default)({
        width: width,
        height: height
    }), fakeCtx = _a.ctx, fakeCanvas = _a.canvas;
    var sides = (0, _generateSidesDefault.default)(width, height);
    document.body.append(fakeCanvas);
    ctx.strokeStyle = "gray";
    fakeCtx.strokeStyle = "gray";
    var getImageFromFakeCanvas = function(originalCanvasImg, points) {
        fakeCtx.clearRect(0, 0, width, height);
        fakeCtx.drawImage(originalCanvasImg, 0, 0, width, height);
        fakeCtx.beginPath();
        points.map(function(_a) {
            var x = _a.x, y = _a.y;
            return fakeCtx.lineTo(x, y);
        });
        fakeCtx.stroke();
        fakeCtx.closePath();
    ...
    var render = function() {
        if (timer % 100 === 0) {
            ...
            // ctx.stroke(p2);
            ctx.beginPath();
            var line = (0, _createLineDefault.default)(sides);
            var lineLength = (0, _calcLineLengthDefault.default)(line.start, line.end);
            var points = (0, _generateTornLineDefault.default)(line.start, line.end, lineLength, parseInt("".concat(lineLength / 7), 10), Math.PI);
...
},{"./createLine":"8BgyF","./calcLineLength":"eQvhG","./generateTornLine":"jF1AU","./createCanvas":"lyLua","./generateSides":"cHZXk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8BgyF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _lodashShuffleDefault = parcelHelpers.interopDefault(_lodashShuffle);
const getRandomPointOnSide = ({ start , end  })=>{
    return {
        x: start.x === end.x ? start.x : (0, _lodashRandomDefault.default)(start.x, end.x, true),
        y: start.y === end.y ? start.y : (0, _lodashRandomDefault.default)(start.y, end.y, true)
    };
};
const createRandomLine = ({ TOP , RIGHT , BOTTOM , LEFT  })=>{
    const [startSide, endSide] = (0, _lodashShuffleDefault.default)([
        TOP,
        RIGHT,
        BOTTOM,
        LEFT
...
},{"lodash.random":"2LJLN","lodash.shuffle":"28MCs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2LJLN":[function(require,module,exports) {
/**
...
/* Built-in method references for those with the same name as other `lodash` methods. */ var nativeFloor = Math.floor, nativeMin = Math.min, nativeRandom = Math.random;
/**
...
},{}],"28MCs":[function(require,module,exports) {
/**
 * lodash (Custom Build) <https://lodash.com/>
 * Build: `lodash modularize exports="npm" -o ./`
 * Copyright jQuery Foundation and other contributors <https://jquery.org/>
 ...
 * Based on Underscore.js 1.8.3 <http://underscorejs.org/LICENSE>
 * Copyright Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
 */ /** Used as references for various `Number` constants. */ var global = arguments[3];
...
/** `Object#toString` result references. */ var argsTag = "[object Arguments]", funcTag = "[object Function]", genTag = "[object GeneratorFunction]", mapTag = "[object Map]", objectTag = "[object Object]", promiseTag = "[object Promise]", setTag = "[object Set]", stringTag = "[object String]", symbolTag = "[object Symbol]", weakMapTag = "[object WeakMap]";
...
/** Built-in value references. */ var Symbol = root.Symbol, iteratorSymbol = Symbol ? Symbol.iterator : undefined, propertyIsEnumerable = objectProto.propertyIsEnumerable;
/* Built-in method references for those with the same name as other `lodash` methods. */ var nativeFloor = Math.floor, nativeKeys = overArg(Object.keys, Object), nativeRandom = Math.random;
...
},{}],"eQvhG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jF1AU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _lodashRandom = require("lodash.random");
var _lodashRandomDefault = parcelHelpers.interopDefault(_lodashRandom);
...
const applyOffset = (point, offset)=>{
    ...
    return {
        x: point.x + (0, _lodashRandomDefault.default)(offsetAbs * -1, offsetAbs, true),
        y: point.y + (0, _lodashRandomDefault.default)(offsetAbs * -1, offsetAbs, true)
    };
};
const generateTornLine = (start, end, lineLength, countOfPoints, offset)=>{
    ...
    const { points  } = Array.from({
        ...
        const randDistance = (0, _lodashRandomDefault.default)(onePartSize * i, onePartSize * (i + 1), true);
...
},{"lodash.random":"2LJLN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cHZXk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire2aa2")
